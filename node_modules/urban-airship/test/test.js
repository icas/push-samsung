	// Your API key
var API_KEY = "Cfs2G500S_Gwj20kra_1QA",
	// Your API master key
	MASTER_KEY = "N5aOLFOuRz63LgZ-VBJ5ow",
	// Your API secret key
	SECRET_KEY = "0MAmrdiETnq3__5dfj0K-g",
	// 1 to run a broadcast test, 0 to skip
	TEST_BROADCAST = 1,
	// The number of test events to wait for
	EXPECTED_TESTS = 1 + TEST_BROADCAST,
	// The device_token for your test device
	TEST_DEVICE = "5680e522-147f-481e-a879-366850cf4ffa",
...
Test.prototype.pushBroadcast = function() {
	var self = this,
		...
		payload = {
			"android": {"alert": "hi"}, "apids": [TEST_DEVICE]
		};
